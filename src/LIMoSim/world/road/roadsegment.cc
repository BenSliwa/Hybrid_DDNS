...
double RoadSegment::computeStretchFactor(double _angle0, double _angle1)
{
    double angle = _angle0;
    double angleDifference = Vector3d::computeMinimumAngleDifference(angle, _angle1);
    double strechFactor = cos(Vector3d::toRad(angleDifference));
